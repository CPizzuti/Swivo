...
import com.android.swivo.service.ServiceUtils;
import com.android.swivo.ui.FriendsFragment;
import com.android.swivo.ui.GroupFragment;
import com.android.swivo.ui.LoginActivity;
import com.android.swivo.ui.UserProfileFragment;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(toolbar != null) {
            ...
            getSupportActionBar().setTitle("Swivo");
        }
...
//    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.about) {
            Toast.makeText(this, "Swivo version 1.0", Toast.LENGTH_LONG).show();
            return true;
        }
