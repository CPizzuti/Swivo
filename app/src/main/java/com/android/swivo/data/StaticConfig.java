package com.android.swivo.data;
...
public class StaticConfig {
    ...
    //public static String UID = "ZUpRjXz2fEgDWI2NrgbuFkwpxk12";
    ...
    public static String AUDIO_FILE_PLAYED = "com.android.swivo.playedFile";
